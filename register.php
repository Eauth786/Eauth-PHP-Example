...
if (isset($_POST['register']))
{
    ...
    $Invite = $_POST['Invite'];
    $auth->signup($Username, $Password, $Invite);
}
?>
<!doctype html>
<html lang="en">
...
<main class="form-signin w-90 m-auto">
    <h1 class="h5 mb-3 fw-normal">Create an account...</h1>
    ...
    <div class="form-floating">
    <input class="form-control mt-3" placeholder="License Key" type="text" name="Invite" required/>
      <label for="floatingPassword">License Key</label>
    </div>
    <button class="w-100 btn btn-lg btn-primary mt-3" name="register" type="submit">SIGN UP</button>
    <a class="w-100 btn btn-lg btn-primary mt-3" href="index.php" type="button">Already have Account</a>
